...
const SOURCE_FOLDER = process.env.GALLERY_SOURCE;
...
async function main() {
  ...
  if (!SOURCE_FOLDER) {
    console.error('Error: GALLERY_SOURCE not set.');
    console.error('Create a .env file with GALLERY_SOURCE=/path/to/your/images');
    process.exit(1);
  }
